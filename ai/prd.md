...
- **Frontend:** HTMX, JavaScript, Tailwind CSS, DaisyUI (CSS Framework)
- **Templating:** Handlebars (via `aymerick/raymond`)
- **Database:** SQLite
- **Data Formats:** JSON-LD for structured data, RDF for Schema.org graph processing.
